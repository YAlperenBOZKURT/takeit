...
mixin _$Message {
  ...
  MessageType get type =>
      throw _privateConstructorUsedError; // file metadata (only used when type == fileMeta)
...
class _$MessageImpl implements _Message {
  ...
  @override
  String toString() {
    return 'Message(id: $id, roomId: $roomId, senderId: $senderId, senderAlias: $senderAlias, content: $content, timestamp: $timestamp, type: $type, fileName: $fileName, fileSize: $fileSize, fileMimeType: $fileMimeType, savePath: $savePath)';
  }
...
abstract class _Message implements Message {
  ...
  @override
  MessageType get type; // file metadata (only used when type == fileMeta)
  @override
  String? get fileName;
  @override
  int? get fileSize;
